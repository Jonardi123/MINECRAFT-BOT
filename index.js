...
const { loadMemory, saveMemory, rememberPlayer, setPosition, setChest } = require('./memory')
const { createSpeaker } = require('./speaker')
const { createTaskManager } = require('./lib/taskManager')
const { setupMovement, goNear, followPlayer, rushToPlayer, stopMoving, wanderNearHome, getHomePosition } = require('./navigation')
const { summarizeInventory, dropItemToPlayer, findItem, normalizeName } = require('./inventory')
const { findChestPositionNearLook, depositInventory, checkSupplies } = require('./chest')
const { ensurePickaxe, equipBestArmor, equipBestArmorFromInventory } = require('./equipment')
const { mineBlocks, prospectMine, smartMineResource, stripMine, branchMine, branchMineForResource, staircaseMine, safeCaveExplore, mineArea, torchMine, findExposedBlocks } = require('./mining')
const { farmTarget } = require('./farming')
const { createProtector } = require('./protection')
...
const { createPvpController } = require('./pvp')
const { equipBestWeapon, equipBestShield, equipBestTotem, recoverDangerousFall, createFallRecoveryState } = require('./combat')
const { buildStarterCamp, buildEmergencyShelter, buildBase, buildFancyBase } = require('./building')
const { normalizePaletteName } = require('./baseBlueprints')
const { cookFood, makeBedAndSetSpawn, sleepInOwnBed } = require('./domestic')
const { runDiamondBeaconObjective, beaconStatus, setBeaconSite } = require('./beaconObjective')
const { createMobDefenseController } = require('./mobDefense')
const { createSurvivalDispatcher } = require('./lib/survivalDispatcher')
const { createAiController } = require('./aiController')
const { getLlmStatus } = require('./llmStatus')
const { executeAiAction } = require('./aiActions')
const { startAutopilot, autoplayStatus } = require('./autopilot')
const { recordDamage, recordDeath, rewardSummary } = require('./rewardSystem')
const { adaptiveThreatSummary, recordDamageMemory } = require('./modThreat')
const { loadOptionalPlugins } = require('./pluginLoader')
const { createDashboardServer } = require('./dashboard')
const { createGoalPlanner, formatPlannerStatus } = require('./goalPlanner')
const { runPlannerRecommendation } = require('./goalExecutor')
