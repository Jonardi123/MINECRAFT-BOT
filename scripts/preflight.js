...
const { loadConfig, configPathLabel } = require('../lib/configLoader')
...
const requiredFiles = [
  ...
  'lib/stockpile.js',
  'lib/survival.js',
  'lib/survivalDispatcher.js',
  'lib/taskManager.js',
  'lib/versionSupport.js',
  'lib/worldSummary.js',
  'lib/jsonDecision.js',
  'lib/llmStatus.js',
  'lib/knowledge.js',
  ...
  'lib/survivalDirector.js',
  'lib/curriculum.js',
  'lib/skillRegistry.js',
  'lib/critic.js',
  'lib/agentCore.js',
  'lib/miningPlanner.js',
  'lib/combatPlanner.js',
  'lib/loadouts.js',
  'lib/pluginLoader.js',
